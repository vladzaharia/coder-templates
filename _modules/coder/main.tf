...
locals {
  ...
  # Editor selections
  vscode_enabled = var.ask_editors ? try(data.coder_parameter.vscode_enabled[0].value, true) : true
  vscode_insiders_enabled = var.ask_editors ? try(data.coder_parameter.vscode_insiders_enabled[0].value, false) : false
}
