...
resource "aws_key_pair" "dev" {
  key_name   = "coder-${data.coder_workspace_owner.me.name}-${data.coder_workspace.me.name}-key-pair"
...
resource "coder_metadata" "key-pair" {
  ...
  item {
    key   = "name"
    value = "coder-${data.coder_workspace_owner.me.name}-${data.coder_workspace.me.name}-key-pair"
  }
}
...
resource "coder_metadata" "vpc" {
  ...
  item {
    key   = "name"
    value = "coder-${data.coder_workspace_owner.me.name}-${data.coder_workspace.me.name}-vpc"
  }
  item {
    key   = "cidr block"
...
resource "aws_subnet" "dev" {
  ...
  tags = {
    Name = "coder-${data.coder_workspace_owner.me.name}-${data.coder_workspace.me.name}-subnet"
  }
}
...
resource "coder_metadata" "subnet" {
  ...
  item {
    key   = "name"
    value = "coder-${data.coder_workspace_owner.me.name}-${data.coder_workspace.me.name}-subnet"
  }
  item {
    key   = "cidr block"
...
#   name        = "coder-${data.coder_workspace_owner.me.name}-${data.coder_workspace.me.name}-allow-rdp"
...
resource "aws_security_group" "allow_all" {
  name        = "coder-${data.coder_workspace_owner.me.name}-${data.coder_workspace.me.name}-allow-all"
